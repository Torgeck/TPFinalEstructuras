...
public class ArbolAVL {
    ...
    public boolean insertar(Object elemento, Comparable key){
        // Inserta un elemento en el arbol AVL, retorna un boolean dependiendo si inserto o no el elemento
        boolean exito = true;
    ...
    private boolean eliminarAux(NodoAVL padre, NodoAVL nodo, Comparable key) {
        // Metodo auxiliar que recorre el arbol en forma recursiva hasta encontrar el nodo a eliminar
        boolean exito = false;

        // Si no es nulo lo busco
        if(nodo != null){
            // Si es el nodo actual entonces lo elimino segun el caso y cambio el boolean a retornar
            if(key.compareTo(nodo.getKey()) == 0){
                exito = true;
    ...
    public boolean eliminarMinimo(){
        //Metodo que elimina el minimo de un arbolAVL haciendo uso de metodos anteriores
        boolean exito = false;
    ...
    private boolean eliminarMinimoAux(NodoAVL padre, NodoAVL nodo){
        // Metodo que recorre el arbol recursivamente hasta encontrar el nodo minimo para eliminarlo
        boolean exito;
    ...
    public boolean eliminarMaximo(){
        //Metodo que elimina el maximo de un arbolAVL haciendo uso de metodos anteriores
        boolean exito = false;
        //Checkeo que el arbol no este vacio
        if(this.raiz != null){
    ...
    private boolean eliminarMaximoAux(NodoAVL padre, NodoAVL nodo){
        // Metodo que recorre el arbol recursivamente hasta encontrar el nodo maximo para eliminarlo
        boolean exito;
