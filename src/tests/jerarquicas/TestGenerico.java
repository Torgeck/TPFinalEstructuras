...
public class TestGenerico {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Busco el nivel de raiz. Tiene que dar " + sOk + " --> " + ((a.nivel(10) == 0) ? sOk : sErr));
        System.out.println("Inserto el 9 como hijo de 10 " + ((a.insertar(9, 10)) ? sOk : sErr));
        System.out.println("Busco el nivel de 9. Tiene que dar " + sOk + " --> " + ((a.nivel(9) == 1) ? sOk : sErr));
        ...
        System.out.println("Busco el nivel de 3. Tiene que dar " + sOk + " --> " + ((a.nivel(3) == 2) ? sOk : sErr));
        ...
        System.out.println("Busco ancentros de 3 deberia dar 9 - 10 : " + a.ancestros(3).toString());
        System.out.println("Busco ancentros de 40 deberia dar  30 - 15 - 10  : " + a.ancestros(40).toString());
        ...
        System.out.println("Busco el nivel de raiz. Tiene que dar " + sOk + " --> " + ((a.nivel(10) == 0) ? sOk : sErr));
        System.out.println("Busco el nivel 3. Tiene que dar " + sOk + " --> " + ((a.nivel(3) == 2) ? sOk : sErr));
        System.out.println("Busco el nivel 20. Tiene que dar " + sOk + " --> " + ((a.nivel(20) == 2) ? sOk : sErr));
        System.out.println("Busco el nivel 9. Tiene que dar " + sOk + " --> " + ((a.nivel(9) == 1) ? sOk : sErr));
        System.out.println("Busco el nivel 22. Tiene que dar " + sOk + " --> " + ((a.nivel(22) == 2) ? sOk : sErr));
        System.out.println("Busco el nivel 45. Tiene que dar " + sOk + " --> " + ((a.nivel(45) == 3) ? sOk : sErr));
        System.out.println("Busco el nivel 55. Tiene que dar " + sOk + " --> " + ((a.nivel(55) == 3) ? sOk : sErr));
        ...
        System.out.println("\n");
        System.out.println("Recorrido en Niveles.\n Tiene que dar: [ 10 - 9 - 15 - 7 - 3 - 12 - 20 - 22 - 30 - 10 - 40 - 45 - 55]  " + a.listarNiveles().toString());

        Lista lista = new Lista();
        lista.insertar(10,lista.longitud()+1);
        lista.insertar(0,lista.longitud()+1);
        lista.insertar(12,lista.longitud()+1);

        System.out.println("Test de patron " + a.verificarPatron(lista));
        System.out.println("Test frontera " + a.frontera());
    }
