...
public class ArbolGen {
    ...
    public boolean insertar(Object elementoNuevo, Object elementoPadre) {
        //Metodo que inserta elementoNuevo como hijo de la primera aparicion de elementoPadre
        boolean respuesta = true;

        //Checkeo si el arbol esta vacio en caso de que lo este inserto elemento como raiz
        if(this.esVacio())
        ...
        //En caso de que no este vacio recorro el arbol en busca del padre
            ...
            if(nodoPadre != null){
                ...
                //Caso contrario busco al ultimo hermano derecho para crear y setear el nuevo nodo
                else{
    ...
    private NodoGen obtenerNodo(NodoGen nodoActual, Object elemento) {
        //Metodo que encuentra y retorna un nodo que contiene al elemento buscado en Preorden
        ...
        if(nodoActual != null) {
            ...
            //Si no se encuentra nos movemos a sus hijos
                ...
                //Nos movemos al hijo del nodo, en caso de no tener no entra en el loop y retorna null
                NodoGen hijo = nodoActual.getHijoIzquierdo();

                //Hacemos las llamadas recursiva de este metodo para cada hijo del nodo actual; si lo encuentra se corta
    ...
    public Lista ancestros(Object elemento) {
        //Metodo que devuelve una lista con el camino desde la raiz hasta dicho elemento si es que ese elemento se encuentra en el AG
    ...
    private boolean ancestrosAux(NodoGen nodoActual, Object elemento, Lista lista) {
        //Metodo que busca el nodo que contiene al elemento y retorna un boolean si es que lo encuentra
    ...
    public boolean esVacio() {
        //Metodo que retorna true en caso de que el arbol este vacio y false en caso de no estarlo
    ...
    private int obtenerAltura(NodoGen nodoActual, int altura) {
        ...
        if(nodoActual != null){
            ...
            //Busco altura en los hermanos de nodoActual, como estoy en el mismo nivel paso la misma altura
        ...
        if(nodo != null) {
            ...
            if(nodo.getElemento().equals(elemento)){
               nivel++;
                ...
                //Si nivel cambio entonces se encontro en el nivel inferior por lo tanto le sumo 1
                if(nivel != -1)
                    nivel++;
    ...
    public Object padre(Object elemento){
        ...
        //Si el arbol esta vacio o si la raiz es elemento a la que se le busca el padre retorna null; caso contrario busca al padre
    ...
    private Object buscaElementoPadre(NodoGen nodoActual, Object elemento) {
        ...
        if(nodoActual != null) {
            ...
            //Chekeamos si alguno de los hijos del nodo actual es el buscado si es que tiene
    ...
    private void listarInordenRecursivo(NodoGen nodoActual, Lista lista) {
        ...
        if(nodoActual != null){
            ...
            //Recorro los hijos de nodoActual (Avanzo hijo primero ya que se inserto previamente)
            while(hijo != null){
                hijo = hijo.getHermanoDerecho();
                listarInordenRecursivo(hijo,lista);
            }
    ...
    public Lista listarNiveles() {
        //Metoco que retorna una lista con los elementos del AG en el recorrido por niveles
        Lista lista = new Lista();
